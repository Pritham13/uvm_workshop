...
class ahb_master_agent#(ADDR_WIDTH=16,DATA_WIDTH=16) extends uvm_agent;
    ...
    ahb_master_driver#(ADDR_WIDTH,DATA_WIDTH) master_driver;
    ahb_master_monitor#(ADDR_WIDTH,DATA_WIDTH) master_monitor;
    ahb_master_sequencer#(ADDR_WIDTH,DATA_WIDTH) master_sequencer;

    // Register the class ahb_master_agent with the factory.
    `uvm_component_param_utils(ahb_master_agent#(ADDR_WIDTH,DATA_WIDTH))
...
function void ahb_master_agent::build_phase(uvm_phase phase);
    ...
    begin
        master_driver = ahb_master_driver#(ADDR_WIDTH,DATA_WIDTH)::type_id::create("master_driver", this);
        master_sequencer = ahb_master_sequencer#(ADDR_WIDTH,DATA_WIDTH)::type_id::create("master_sequencer", this);
    end

    // Build the Monitor regardless of whether agent is active or passive.
    master_monitor = ahb_master_monitor#(ADDR_WIDTH,DATA_WIDTH)::type_id::create("master_monitor", this);
