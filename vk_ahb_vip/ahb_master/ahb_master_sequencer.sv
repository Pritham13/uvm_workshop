...
class ahb_master_sequencer#(ADDR_WIDTH=16,DATA_WIDTH=16) extends uvm_sequencer#(ahb_master_transaction#(ADDR_WIDTH,DATA_WIDTH));

    // Register the class ahb_master_sequencer with the factory.
    `uvm_component_param_utils(ahb_master_sequencer#(ADDR_WIDTH,DATA_WIDTH))
